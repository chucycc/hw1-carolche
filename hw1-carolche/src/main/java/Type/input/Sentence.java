...
public class Sentence extends Annotation {
  ...
  */  
  ...
  /** getter for id - gets The sentence identifier of input data.
   * @generated
   * @return value of the feature 
   */
  public String getId() {
    if (Sentence_Type.featOkTst && ((Sentence_Type)jcasType).casFeat_id == null)
      jcasType.jcas.throwFeatMissing("id", "Type.input.Sentence");
    return jcasType.ll_cas.ll_getStringValue(addr, ((Sentence_Type)jcasType).casFeatCode_id);}
    
  /** setter for id - sets The sentence identifier of input data. 
   * @generated
  ...
  /** getter for text - gets The text of the input data. It would be a sentence which will contains different gene names.
   * @generated
   * @return value of the feature 
   */
  public String getText() {
    if (Sentence_Type.featOkTst && ((Sentence_Type)jcasType).casFeat_text == null)
      jcasType.jcas.throwFeatMissing("text", "Type.input.Sentence");
    return jcasType.ll_cas.ll_getStringValue(addr, ((Sentence_Type)jcasType).casFeatCode_text);}
    
  /** setter for text - sets The text of the input data. It would be a sentence which will contains different gene names. 
   * @generated
   * @param v value to set into the feature 
   */
