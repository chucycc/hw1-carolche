...
public class Sentence_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("Type.input.Sentence");
  ...
  public String getId(int addr) {
      ...
      jcas.throwFeatMissing("id", "Type.input.Sentence");
  ...
  public String getText(int addr) {
      ...
      jcas.throwFeatMissing("text", "Type.input.Sentence");
