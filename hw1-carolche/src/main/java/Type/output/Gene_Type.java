...
public class Gene_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("Type.output.Gene");
  ...
  public String getId(int addr) {
      ...
      jcas.throwFeatMissing("id", "Type.output.Gene");
  ...
  public String getName(int addr) {
      ...
      jcas.throwFeatMissing("name", "Type.output.Gene");
